...
func TestPickGenerator_Generate_Unique(t *testing.T) {
...
func TestPickGenerator_Generate_NonUnique(t *testing.T) {
	sourceTable := model.CSVFile{
		Name:   "source",
		Header: []string{"id", "name", "value"},
		Lines: [][]string{
...
func TestPickGenerator_Generate_ErrorCases(t *testing.T) {
	generator := PickGenerator{
		SourceTable:  "source",
		SourceColumn: "name",
		SourceValue:  "value",
...
func TestPickGenerator_findUnusedValue(t *testing.T) {
	generator := PickGenerator{}
